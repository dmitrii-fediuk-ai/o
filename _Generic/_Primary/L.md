...
### Rationale
⟨ Ⱳ https://en.wikipedia.org/wiki/Local_variable ⟩ сокращают мне запись: я могу в рамках `☷` вводить короткие обозначения, не беспокоясь о конфликте этих обозначений с остальной частью моего запроса.
