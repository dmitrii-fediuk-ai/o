...
# 44. ꘖ
## 44.1. Definitions using a global symbol
### 44.1.1. 
#### Syntax
~~~code
ꘖ A ∋ B
...
## 44.2. Definitions using local keys
### 44.2.1. Common rules
####
В §44.1 мы описывали an attribute / property of `A` using глобально доступный затем символ `B`.
####
В §44.2 мы описываем attributes / properties of `A` иначе: using local keys.
####
