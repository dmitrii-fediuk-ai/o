...
~~~
###
Другими словами, это означает `☷` от §P₁ и до §Pₙ, включая §P₁ и §Pₙ.
## Examples
###
...
## Meaning
~~~code
⠿ ⟨ `☷` от начала и до пункта Pₙ включительно ⟩` 
~~~

# 22. §[P₁ - ]
## Meaning
~~~code
⠿ ⟨ `☷` от пункта P₁ включительно и до конца `᛭Dᵢ` ⟩ 
~~~  
...
## Определение границ `☷`
Границы `☷` задаются способами §〔18 - 22〕.
Границы `☷` задаются способами §〚18 - 22〛.
Границы `☷` задаются способами §〔18 - 22〕.
Границы `☷` задаются способами §〔18 - 22〕.
Границы `☷` задаются способами §〔18 - 22〕.
