...
## Meaning
###
`⠿ ⟪ пункты документа ⟫ [P₁ - Pₙ]` 
###
Другими словами, это означает фрагмент документа от §P₁ и до §Pₙ, включая §P₁ и §Pₙ.
## Examples
###
`§[2 - 5]` означает `⠿ ⟪ пункты ᛭Dc ⟫ [2 - 5]`.
###
`A∷§{2 - 5}` означает `⠿ ⟪ пункты A ⟫ [2 - 5]`

# 20. §[0 - Pₙ]
## Meaning
`⠿ ⟨ фрагмент документа от начала и до пункта Pₙ включительно ⟩` 

# 21. §[P₁ - ]
## Meaning
`⠿ ⟨ фрагмент документа от пункта P₁ включительно и до конца документа ⟩` 
