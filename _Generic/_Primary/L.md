...
# 9. ⠿ ⟪ M ⟫ [I₁ - Iₙ]  
## Meaning
Такая запись определяет множество посредством точного указания интервала/диапазона значений некоего упорядоченного надмножества `M`.
Итоговое множество включает границы указанного интервала: `I₁` и `Iₙ`. 
## Examples
###
`⠿ ⟪ пункты документа X ⟫ {1 - 5}` означает «множество пунктов документа `X` от пункта 1 до пункта 5 включительно».
###
