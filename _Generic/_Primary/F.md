...
# Кавычки / `«»`
##
Используй `«»` в качестве кавычек по умолчанию.
...
##
Обрамляй точные `ꑌ𐏕` backticks.
##
Обрамляй названия элементов User Interface `«»`.
## 
В качестве кавычек точных `ꑌE` в сферах математики, Computer Science и т. п. используй backticks.
###
