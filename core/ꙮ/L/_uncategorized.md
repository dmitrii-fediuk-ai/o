...
#
The `ꑌ𝔼` representing the `ꑌꕤ` of the `ꑌ𐏕` which is the `ꑌⱳ_Topic` of the `ꑌⱳ_Article` at <code>https://en.wikipedia.org/wiki/$\underbrace{x}_\text{real}$</code>.  
...
$$
https://en.wikipedia.org/wiki/$\underbrace{x}_\text{real}
$$
#
$$
z = \overbrace{
